...
/** @var string $totalEarnings */
/** @var string $totalProducts */
/** @var int $totalOrders */
/** @var int $totalPendingOrders */
/** @var array $labels */
/** @var array $data */
/** @var array $countries */
/** @var array $bgColors */
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        <?php foreach ($countries as $i => $country):?>
                            <span class="mr-2">
                                <i class="fas fa-circle" style="color: <?php echo $bgColors[$i]?>"></i>
                                <?php echo $country?>
                            </span>
                        <?php endforeach;?>
                    </div>
